...
public final class QueryUtils {
    ...
    public static ArrayList<Earthquake> extractEarthquakes() {
        ...
        try {
            ...
            JSONArray featureArray = earthquakeJSON.getJSONArray("features");
            ...
            for (int i = 0; i < featureArray.length(); i++) {
                ...
                Earthquake earthquake = new Earthquake(place, getFormattedDate(time), getFormattedTime(time),magnitude, url);
    ...
    private static String getFormattedDate(long timeInMilliseconds){
    ...
    private static String getFormattedTime(long timeInMilliseconds){
